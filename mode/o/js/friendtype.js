...
function creatFriendType(latter,ftid,name,u){
	...
	li.innerHTML = '<span class="fr b pdr gray" style="cursor: pointer;display:none" onclick="pwConfirm(\'是否确认删除\',this,function(){delFriendType(\''+ftid+'\',\''+u+'\')})">x</span><span class="fr pdr gray" style="cursor: pointer;display:none" onclick="showEidt(\''+ftid+'\',\''+u+'\');">编辑</span><a href="mode.php?m=o&q=friend&ftid='+ftid+'">'+name+'</a>';
